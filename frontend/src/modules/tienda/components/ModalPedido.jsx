...
const s = {
  ...
  btnPrimary: { padding: "13px", background: "#3674B5", color: "#fff", border: "none", borderRadius: 10, fontSize: 15, fontWeight: 700, cursor: "pointer", marginTop: 4 },
  ...
  resumenTitulo: { fontSize: 12, fontWeight: 700, color: "#3674B5", textTransform: "uppercase", margin: "0 0 10px", letterSpacing: "0.04em" },
